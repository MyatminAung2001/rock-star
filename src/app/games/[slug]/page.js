  ...
  return (
    <div className="default-section-padding">
      ...
      <div>
        ...
        <Description title="About" description={gameDetails?.description_raw} />
        <div className="mb-3 flex flex-wrap">
          <div className="mb-2 w-[50%] xl:w-[20%]">
            <p className="text-primary-white text-lg tracking-wide">Rating</p>
        ...
        {gameDetails?.website && (
          <div className="mb-3">
            <p className="text-primary-white text-lg tracking-wide">Website</p>
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5">
            {gameDLCAndEditions?.results.map((edition) => (
              <div
                key={edition.id}
                onClick={() => router.push(`games/${edition.slug}`)}
              >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5">
            {gameSeries?.results.map((series) => (
              <div
                key={series.id}
                onClick={() => router.push(`games/${series.slug}`)}
              >
